...
def create_datasets(n_samples: int,
                    circle_noise: float = .05,
    ...
    data = [
        (noisy_circles, {'damping': 0.9, 'preference': -240,
                         'quantile': .2, 'n_clusters': 3}),
        (noisy_moons, {'damping': .75, 'preference': -220, 'n_clusters': 3}),
        (varied, {'eps': .18, 'n_neighbors': n_neighbors}),
        (aniso, {'eps': .15, 'n_neighbors': n_neighbors}),
        (blobs, {}),
        (no_structure, {})]
