...
\begin{frame}
    ...
    \Fontvi
    Taking into account the topology of data is beneficial for interpolation. Data lies on some compact topological manifold, which is given by the  mutual  arrangement  of  a  dataset.\\[0.5cm] 
    \centering
