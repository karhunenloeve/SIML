...
\begin{frame}
    ...
    \hspace{1cm}
    \includegraphics[width=4cm]{figure2_d_DEL.pdf}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item A mathematical plausible stopping condition for interpolation techniques.
    ...
    \begin{itemize}
        ...
        \item Does Voronoi interpolation (computed this way) preserve homology groups?
    \end{itemize}
\end{frame}
\end{document}