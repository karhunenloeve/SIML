...
class ant_colony:
    class ant(Thread):
        def __init__(self, init_location, possible_locations, pheromone_map,
            ...
            """
            Class for the Ant-Colony algorithm.
            :param init_location:
            :param possible_locations:
            :param pheromone_map:
            :param distance_callback:
            :param alpha:
            :param beta:
            :param first_pass: Default value is false.
            ...
            - beta -> A parameter from ACO that controls the influence of the distance to the next node in _pick_path().
